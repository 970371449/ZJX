<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\phpstudy_pro\WWW\thinkphp\public/../application/admin\view\login\loginindex.html";i:1635435729;}*/ ?>
<!DOCTYPE>
<html>
...
<head>
    ...
    <script src="//tjs.sjs.sinajs.cn/open/api/js/wb.js?appkey=4262232852" type="text/javascript" charset="utf-8"></script>
</head>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3" style="background:white">
            <form action="http://192.168.0.103:8001/admin/Login/loginJump" method="post" class="form-horizontal" role="form">
                ...
                <div class="row">
                    <div class="col-lg-6 col-lg-offset-2" style="background:white;">
                        <p>
                            ...
                            <a id="microBlog_login" href=""><img src="/static/img/weibo_login.png" title="点击进入授权页面" alt="点击进入授权页面" border="0" /></a>
                        </p>
                    </div>
                </div>
                <div class="row">
...
<script>
    $(function () {
        $.ajax({
            type:'post',
            url:'<?php echo url("admin/Login/loginIndex"); ?>',
