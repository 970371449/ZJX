<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpstudy_pro\thinkphp\public/../application/admin\view\login\login.html";i:1628259064;}*/ ?>
<!DOCTYPE>
<html>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3" style="background:white">
            <form action="admin/Login/loginJump" method="post" class="form-horizontal" role="form">
